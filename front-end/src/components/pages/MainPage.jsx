...
const MainPage = (props) => {
    ...
    return (
        <div style={wrapperStyle}>
            ...
            <Main gap="3.8rem">
                <Shortcut page={"map"} setPageState={setPageState} bgcolor={"#5C9259"} name={"WHERE \n IS?"} explanation={"내 주변 가장 가까운 \n 쓰레기장은 어디일까?"} color={"#ffffff"}></Shortcut>
                <Shortcut page={"tip"}  setPageState={setPageState} bgcolor={"#E7EFE8"} name={"HOW \n TO?"} explanation={"어떻게 버려야 하지?"} color={"#000000"}>
                ...
                <Shortcut page={"community"}  setPageState={setPageState} bgcolor={"#E7EFE8"} name={"OUR \n GREENDUKLIFE"} explanation={"우리의 그린덕라이프를 공유하자"} color={"#000000"}></Shortcut>
            </Main>
        </div>
    );
};
